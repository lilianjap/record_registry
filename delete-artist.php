...
<div class="container">
<form class='newrecord' id="newrecord" method="post" action="delete-query-artist.php">
	<fieldset>
		<legend>Delete artist from collection</legend>
		Artist: <input type="text" name="artist_name" id="artist_name"> <br/> <br/>
		<input class="btn btn-default btn-lg" type="submit" name="go" id="go" value="Delete artist" />
