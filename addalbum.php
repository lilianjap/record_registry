<html>
  ...
  <div id=header>
    ...
    <h1>Register your new music!</h1>
<div class="container">
<form class='newrecord' id="newrecord" method="post" action="addalbum-query.php">
	<fieldset>
    ...
    <input class="btn btn-default" type="submit" name="go" id="go" value="Add Album" />
